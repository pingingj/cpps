...
// static void	print_database(std::map<std::string, float> &db)
// {
...
static bool	parse_files(std::ifstream &input_file, std::ifstream &data)
{
...
static bool	parse_btc(std::string &date, std::string &value, bool file)
{
	t_date d;
...
static bool make_database(std::map<std::string, float> &db, std::ifstream &data)
{
	std::string		date;
	std::string		value;
	std::string		line;
